...
Our results show that while the rank-based evaluation method can use human-written web content to show broad differences in the effectiveness of LLM answers, it is not able to show fine-grained differences.