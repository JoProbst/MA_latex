...
The results and visualizations needed to evaluate the research questions formulated in Section \ref{sec:research-question} are presented.
...
The answers by Llama models which are formatted as lists score higher than the non-list ones, while for the remaining models the answer rank follows the ChatGPT pattern, in that list-style answers are ranked lower than non list-style answers.
