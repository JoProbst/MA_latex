...
DPH\_qe     & 0.637 & \textbf{0.751} & 0.51  \\
TF\_IDF     & 0.64  & 0.746 & 0.551 \\
TF\_IDF\_qe & 0.636 & \textbf{0.751} & \textbf{0.557}
\end{tabularx}
\caption{Results of the baseline pipelines, shown as nDCG@10. Query expansion is denoted by \_qe.
...
colbert\_v1      & 0.626 & 0.774 & 0.633 \\
colbertv2        & 0.634 & 0.799 & 0.65  \\
colbertv2-pubmed & 0.62  & 0.783 & 0.606 \\
duoT5            & 0.64  & 0.805 & 0.714 \\
monoT5           & \textbf{0.645} & \textbf{0.813} & \textbf{0.722}
\end{tabularx}
\caption{Results of the transformer pipelines, shown as nDCG@10. The best baseline pipeline is the TF-IDF pipeline with query expansion.}
