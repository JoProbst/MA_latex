...
Finally, the results of ranking the LLM answers are presented and the influence of the different prompting strategies, model sizes and question types are discussed.
...
\\
The results are consistent with the findings by \cite{reynolds:2021:Prompt} that more complex prompting strategies improve the performance of LLMs.
...
\subsection{Evaluation of Badly Ranked ChatGPT Answers}
...
All answers stem from four different queries, namely ``hypothyroidism symptoms'', ``List of multiple sclerosis symptoms'',  ``exercises for better posture'' and ``my risk for developing type 2 diabetes''.
The badly ranked answers for the first three queries all have in common that they are formatted as lists, either enumerated or starting each item with a dash.
From a layperson's perspective, those answers are readable, relevant and credible, generally seeming to answer the question well.
We identify all answers that are formatted as lists by searching for generated answers containing more than five lines, of which at least four start with either a dash or a number.
Table \ref{tab:badly_ranked_answers} shows the mean normalized ranking position of the LLM answers, split by whether the answer is formatted as a list or not.
...
\begin{table}[tb]
    ...
    \hline
    GPT-2        & N/A (0)          & 0.6608 (2000) & N/A (0)          & 0.6608 (2000) \\
    GPT-2 Medium & N/A (0)          & 0.5902 (2000) & N/A (0)          & 0.5902 (2000) \\
    GPT-2 Large  & N/A (0)          & 0.3999 (2000) & 0.4521 (27)      & 0.3992 (1973) \\
    GPT-2 XL     & N/A (0)          & 0.3662 (2000) & 0.2414 (14)      & 0.367 (1986)  \\
    Falcon 7B    & 0.191 (30)       & 0.1461 (1970) & 0.4169 (27)      & 0.1431 (1973) \\
    Llama-2 7B   & 0.0 (1)          & 0.0792 (1999) & 0.0566 (112)     & 0.0805 (1888) \\
    Llama-2 13B  & N/A (0)          & 0.0818 (2000) & 0.07 (206)       & 0.0831 (1794) \\
    ChatGPT      & 0.0578 (20)      & 0.0056 (1980) & 0.0941 (94)      & 0.0017 (1906) \\
    \hline
    \end{tabularx}
\end{table}
