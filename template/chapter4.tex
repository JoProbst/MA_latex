...
The four different sizes of GPT-2 nicely show the effect of model size on ranking performance, with the median ranking position improving with each size increase.
...
\subsection{Evaluation of Lower Ranked ChatGPT Answers}
...
ChatGPT generates a lot of answers formatted as lists, with 748 of the 2000 answers following that pattern.
